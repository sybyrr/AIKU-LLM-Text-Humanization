...
사용:
  /workspace/.venv/bin/python3 adversarial/scripts/s0_train_detector.py
  python adversarial/scripts/s0_train_detector.py --tiny --limit 8 --device cpu   # 스모크
"""
import argparse
import sys
