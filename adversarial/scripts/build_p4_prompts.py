...
사용:
  python adversarial/scripts/build_p4_prompts.py --out adversarial/runs/probes/prompts_p4.jsonl
  # 서버에서:
  #   python scripts/generate.py --in adversarial/runs/probes/prompts_p4.jsonl \\
  #       --out adversarial/runs/probes/gen_p4.jsonl --url .../v1/chat/completions \\
  #       --model qwen3-8b --no-think --temp 0.8 --seed 42 --resume
  #   python adversarial/scripts/s0_probe_external.py --gen adversarial/runs/probes/gen_p4.jsonl \\
...
def main():
    ...
    print("다음: scripts/generate.py 로 생성 → adversarial/scripts/s0_probe_external.py --role evade 로 채점")
