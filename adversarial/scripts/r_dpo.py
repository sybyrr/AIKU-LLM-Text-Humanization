...
초기 KCI 기본값은 lr 5e-6 · β=0.1 · 5 epoch다. 뉴스 team_news overlay는
β=2 · 1 epoch · length-normalized DPOP(λ=5)를 사용한다.
ref logp 는 prefs 에 사전계산돼 있다. 설정과 실험 계보는 adversarial/README.md 참조.
"""
import argparse
import sys
