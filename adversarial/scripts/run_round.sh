...
# 사용:  bash adversarial/scripts/run_round.sh <arm> <round>
#        EXTRA="--limit 32" PY=python3 bash adversarial/scripts/run_round.sh main 1   # 축소 실행
...
AC="$ROOT/adversarial/configs/arms/$ARM.yaml"
EXTRA=${EXTRA:-}
LOGDIR="$ROOT/adversarial/runs/logs"
mkdir -p "$LOGDIR"
...
cfg = C.load_config(root / "adversarial/configs/base.yaml", ac)
