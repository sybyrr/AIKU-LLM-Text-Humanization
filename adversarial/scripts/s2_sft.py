...
사용:
  /workspace/.venv/bin/python3 adversarial/scripts/s2_sft.py
  python adversarial/scripts/s2_sft.py --tiny --limit 8 --epochs 2 --device cpu   # 스모크
"""
import argparse
import sys
