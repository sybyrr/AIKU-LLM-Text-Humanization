#!/usr/bin/env python3
"""Round 단계 ④ — test 생성 + 평가. **탐지기 재학습(⑤) 전에 실행한다.**

--round 0 은 stage2/best 기준선이다: 초기 KCI 경로에서는 SFT, 뉴스 import 경로에서는 G1.
초기 KCI test는 920편, 완료한 뉴스 snapshot은 1,985편이다.
뉴스 G2 러너는 --light로 SimCSE/PPL을 생략한다. 평가 범위는 adversarial/README.md 참조.
...
사용:
  python adversarial/scripts/r_eval.py --arm-config adversarial/configs/arms/main.yaml --round 1
  python adversarial/scripts/r_eval.py --round 0 --light        # SFT 기준선, 무거운 지표 생략
"""
import argparse
import re
import sys
