...
# 사용:  bash adversarial/scripts/run_stage0_2.sh
#        EXTRA="--limit 64" bash adversarial/scripts/run_stage0_2.sh   # 축소 리허설
set -euo pipefail
...
echo "===== check_env ====="
"$PY" "$ROOT/adversarial/check_env.py" || { echo "환경 검사 실패 — 중단"; exit 1; }
...
set +x
echo "Stage 0–2 완료. 육안 검수: adversarial/runs/stage2/samples_dev.md"
