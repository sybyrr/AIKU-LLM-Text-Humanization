"""Plot cross-domain summary and heatmaps from aggregate results.
...
SOURCE = ROOT / "results/reports/cross_domain_current6_full_20260909.html"
...
(METRICS / "cross_domain_results.json").write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
...
# Summary: compare matched and unmatched source/target domains on each detector.
...
# Heatmaps: DPOP-only heatmaps with a single fixed scale and outlined diagonal.
